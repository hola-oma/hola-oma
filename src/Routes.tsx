...
import ReplyOptions from "./shared/features/ReplyOptions";
    ...
    return (
      <div>
        <Switch>
          ...
          <ProtectedRouteHoc exact path="/reply" isLoggedIn={isLoggedIn} public={false} RouteComponent={ReplyOptions} />
